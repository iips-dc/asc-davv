...
class ResourcePeopleControllerTest < ActionController::TestCase
  ...
  test "should create resource_person" do
    assert_difference('ResourcePerson.count') do
      post :create, resource_person: { email: @resource_person.email, mobile: @resource_person.mobile, person_name: @resource_person.person_name }
    end
  ...
  test "should update resource_person" do
    put :update, id: @resource_person, resource_person: { email: @resource_person.email, mobile: @resource_person.mobile, person_name: @resource_person.person_name }
    assert_redirected_to resource_person_path(assigns(:resource_person))
  end
